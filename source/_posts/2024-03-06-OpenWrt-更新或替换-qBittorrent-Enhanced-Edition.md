...
iStoreOS 安装的 qBittorrent 为普通版本，没有反吸血功能。所以想升级到 Enhanced 版本，而且新增种子的时候可以自动添加 tracker，可能增加下载的速度。说干就干。
...
首先关闭 qBittorrent，然后使用 WinSCP 等工具, 打开 /usr/bin 文件夹，删除原本的 qbittorrent-nox 文件。 
